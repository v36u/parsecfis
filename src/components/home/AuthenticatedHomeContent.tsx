        ...
        <>
          {!!numberOfNewReceivedFiles && (
            <div
              ...
              className="z-10 mb-12 rounded-lg border border-blue-300 bg-blue-50 bg-opacity-75 p-4 text-blue-800 dark:border-blue-800 dark:bg-gray-800 dark:text-blue-400"
              role="alert"
            >
          ...
          <label
            ...
            className={classNames(
              'dark:hover:bg-bray-800 mt-1 flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed bg-opacity-50 hover:bg-gray-100 hover:bg-opacity-75 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-gray-500 dark:hover:bg-gray-600',
              {
